...
追熟マスターは、収穫月、品種、エチレン処理温度・時間、寝かせ温度・期間、追熟後賞味期限日数、追熟後出荷可能日数を持つ。収穫月と品種の組み合わせは一意とし、年度管理は行わない。計画作成時に値をコピーし、マスター更新で既存計画を変えない。

### S3-04 収穫月と期限の実装

計画の予約元コンテナを受入ロットまでたどり、受入日の月を収穫月として自動判定する。計画画面では収穫年・収穫月を入力させない。
